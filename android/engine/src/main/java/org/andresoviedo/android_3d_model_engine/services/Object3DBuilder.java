...
public final class Object3DBuilder {
	...
	public static Object3DData modelPoint() {
		...
		return new Object3DData(
				createNativeByteBuffer(vertices.length * 4).asFloatBuffer().put(vertices))
				.setDrawMode(GLES20.GL_TRIANGLE_FAN).setId("ModelPoint").centerAndScale(0.1f).setFaces(new Faces(2));
	}
	...
	public static Object3DData loadV5(Activity activity, Uri modelUri) {
		try {
        	...
        	//data3D.centerAndScale(6,new float[]{0,0,0});
			data3D.centerScale();
